                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card shadow rounded">
                        <div class="card-body text-center mx-auto">
                            <div class="placeholderImage d-flex mx-auto mb-2 justify-content-center shadow-lg align-items-center rounded-circle bg-light" style="width: 150px; height: 150px; 
                            <?php echo ($user['avatar'] != '') ? 'background-image: url(' . $user['avatar'] . ')'  : '' ?>; background-size: cover; background-position: center;">
                            </div>
