    ...
    <div class="card-body text-dark p-4">
        <div class="row justify-content-center text-center">
            <div class="col-md-8 col-lg-6">
                <div class="placeholderImage d-flex shadow-lg mb-3 mx-auto justify-content-center align-items-center rounded-circle bg-light" style="width: 250px; height: 250px; 
                            <?php echo ($user['avatar'] != '') ? 'background-image: url(' . $user['avatar'] . ')'  : '' ?>; background-size: cover; background-position: center;" onerror="this.src='<?php img('avatar-placeholder.jpeg'); ?>';">
                            </div>
