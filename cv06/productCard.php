<div class="col-lg-3 col-sm-11">
  <div class="card mx-auto mb-5 p-0 shadow-sm" style="height: 372px">
    <div class="card-img-top" style="height: 173px; overflow: hidden; width= 286px"><img class="w-100" src="<?php echo $product['image']; ?>"></div>
